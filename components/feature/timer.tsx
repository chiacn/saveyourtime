...
export default function Timer({
    ...
    //useRef
    const refBtnStart = useRef<any>();
    const refBtnReset = useRef<any>();
    const refLoadingBtn = useRef<any>();
    const refRepeat = useRef<any>();
    ...
    // repeat버튼
    const [isRepeat, setIsRepeat] = useState<any>(false);
    ...
    }, [inputPlaceholder, checkText, checkLink])
    ...
    return (
        <div className={styles.frame}>
            ...
            <div className={styles["timer__feature"]}>
                ...
                <div className={styles.timer__inputText}>
                    <InputText
                        inputText={inputText}
